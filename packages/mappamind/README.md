...
Mappamind shows a human what an AI coding agent just did to their system: grounded, visual, in-session at the accept moment. This package installs the `mappamind` command.
